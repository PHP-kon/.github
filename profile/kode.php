 ...
 <img id="logoku" src="img/imageedit_1_4012154301.png" style="position: fixed; top: 15; left: 15; width: 50px;">
  ...
  <body>
    <div class="container">
      ...
      <div class="row">
        <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto; padding: 0 20px;">
          <p style="font-size: 12px; text-align: center; margin-top: 50px;"><strong style="color: #5e5e5e;">Tidak Menerima Kode OTP Festival? <a href="https://wa.me/6282194971220?text=Saya Belum Mendapatkan Kode Kupon Undian" style="text-decoration: none; color: #828282;">Hubungi WhatsApp ADMIN 082194971220</a></strong></p>
        </div>
      </div>
     </center>
